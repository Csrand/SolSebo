...
export class MailService {
  ...
  async sendVerificationEmail(email: string, token: string): Promise<void> {
    ...
    try {
      ...
      console.warn(`[MailService] Failed to send verification email to ${email}:`, (error as Error).message);
    }
  }
  ...
  async sendRecoveryEmail(email: string, token: string): Promise<void> {
    ...
    try {
      ...
      console.warn(`[MailService] Failed to send recovery email to ${email}:`, (error as Error).message);
    }
  }
}
